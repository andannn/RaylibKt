...
//        val player by nativeStateOf { Player(alloc<Vector2>().apply { x = 400f; y = 200f }, 0f, true) }
//        val camera by nativeStateOf { alloc<Camera2D> { zoom = 1f } }
//        val envItems by nativeStateOf {
//            listOf(
