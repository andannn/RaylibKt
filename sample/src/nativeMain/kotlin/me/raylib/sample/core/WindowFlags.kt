            ...
            component("key2") {
                provideHandlers {
                    onDraw {
                        ...
                        if (ConfigFlags.FLAG_VSYNC_HINT.isEnabled()) DrawText(
                        ...
                        if (ConfigFlags.FLAG_WINDOW_HIGHDPI.isEnabled()) DrawText(
                        ...
                        if (ConfigFlags.FLAG_MSAA_4X_HINT.isEnabled()) DrawText(
